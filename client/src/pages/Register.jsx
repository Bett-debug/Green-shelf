          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
              >
                <option value="shopper">Shopper - Browse and purchase eco-friendly products</option>
                <option value="admin">Admin - Manage products and inventory</option>
              </select>
            </div>
          </div>
